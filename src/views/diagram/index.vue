<template>
  <div class="bg">
    ...
    <!-- <chart1 v-if="this.index == 0"></chart1>
    <chart2 v-if="this.index == 1"></chart2> -->
    <div class="contain">
      <test></test>
    </div>
    <footer>
...
import chart3 from './atlas/Maps/Force.vue'
import chart4 from './atlas/Maps/flowDiagram.vue'
import chart5 from './atlas/Maps/funnelDiagram.vue'
import chart6 from './atlas/Maps/treeMap.vue'
import chart7 from './atlas/Maps/sunburst.vue'
import chart8 from './atlas/Maps/parallelDiagram.vue'
import chart9 from './atlas/Maps/radarDiagram.vue'
import test from './atlas/Maps/test.vue'
